package io.kaluh.java8.basic.immutable;
 ...
 * 
 * Other benefit of immutable class is that it is inherently thread-safe, so you
 * don’t need to worry about thread safety in case of multi-threaded
 * environment.
 * 
 * 
...
public final class MyImmutable {
	...
	public MyImmutable(int i, String n, HashMap<String, String> hm) {
	...
	public static void main(String[] args) {
		...
		MyImmutable ce = new MyImmutable(i, s, h1);
