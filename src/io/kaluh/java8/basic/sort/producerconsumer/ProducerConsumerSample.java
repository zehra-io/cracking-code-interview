package io.kaluh.java8.basic.sort.producerconsumer;
 ...
 * producer puts data into the buffer, it wakes up the sleeping consumer. An
 * inadequate solution could result in a deadlock where both processes are
